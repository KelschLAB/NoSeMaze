...
- [Habitat Setup](/Documentation/Guides/setupGuide.md) - Overview of the wiring configuration and guide to setting up the system, including some information to some troubleshooting.
